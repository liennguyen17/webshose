...
if(isset($_POST['themgiohang'])){
	...
	$sql_select_giohang = mysqli_query($con,"SELECT * FROM tbl_giohang WHERE sanpham_id='
	$sanpham_id'");
	...
	if($count>0){
		...
		$soluong = $soluong;
		$sql_giohang = "INSERT INTO tbl_giohang(tensanpham,sanpham_id,giasanpham,soluong,hinhanh) values ('$tensanpham', '$sanpham_id','$gia','$soluong','$hinhanh')";
	}
	...
	if($sql_khachhang){
		...
		$khachhang_id = $row_khachhang['name'];
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-1">
				...
				<?php
					if(isset($_SESSION['dangnhap_home'])){
						echo '<h4 class="text-center" >Khách hàng : '.$_SESSION['dangnhap_home'].'</h2>';
						echo '<h5 class="text-center text-info mb-2"><a class="text-decoration-none mr-2 text-info" href="index.php?quanly=giohang&dangxuat=1">Đăng xuất </a>&#10162;</h5>';
					}else{
						echo '';
					}
					?>
					...
					<table class="timetable_sub">
                        ...
                        ?>
							<tr class="rem1">
								...
								<td class="invert">
									<a style="color:red; font-size:25px; font-weight:bold;" href="?quanly=giohang&xoa=<?php echo $row_fetch_giohang['giohang_id'] ?>">&#10006;</a>
								</td>
							</tr>
							<?php
                        }
					...
					<form action="" method="POST" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								...
								?>
									<input type="submit" name="thanhtoan" class="btn btn-success" style="width: 15%;" value="Thanh toán"> 
							</div>
						</div>
					</form>
