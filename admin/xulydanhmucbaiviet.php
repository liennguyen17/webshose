...
<?php
    if(isset($_POST['themdanhmuc'])){
        ...
        $sql_insert = mysqli_query($con,"INSERT INTO tbl_danhmuc_tintuc(tendanhmuc) values ('$tendanhmuc')");
    }elseif(isset($_POST['capnhatdanhmuc'])){
        $id_post = $_POST['id_danhmuc'];
        $tendanhmuc= $_POST['danhmuc'];
        $sql_update = mysqli_query($con,"UPDATE tbl_danhmuc_tintuc SET tendanhmuc = '$tendanhmuc' WHERE danhmuctin_id = '$id_post'");
        header('Location:xulydanhmucbaiviet.php');
    }
    if(isset($_GET['xoa'])){
        $id = $_GET['xoa'];
        $sql_xoa = mysqli_query($con,"DELETE FROM tbl_danhmuc_tintuc WHERE danhmuctin_id='$id'"); 
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="mt-3">
            <?php
                if(isset($_GET['quanly'])=='capnhat'){
                    $id_capnhat = $_GET['id'];
                    $sql_capnhat = mysqli_query($con,"SELECT * FROM tbl_danhmuc_tintuc WHERE danhmuctin_id = '$id_capnhat'");
            ...
            <div class="row mx-3 my-5" >
                ...
                <?php
                    $sql_select = mysqli_query($con,"SELECT * FROM tbl_danhmuc_tintuc ORDER BY danhmuctin_id ASC");
                ?>
                <table class="table " style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td><a class="text-decoration-none btn btn-outline-danger mr-4" href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>">Xóa</a><a class="text-decoration-none btn btn-outline-success" href="?quanly=?capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>">Cập nhật</a></td>
                    </tr>
                    <?php
                        }
                    ?>
